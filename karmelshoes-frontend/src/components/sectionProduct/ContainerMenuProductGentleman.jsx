...
export const ContainerMenuProductGentleman = ({dataTableProductAvailable}) => {
  ...
  const handlerShowProductBoots = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "ZAPATOS", "BOTINES");
  ...
  const handlerShowProductBootes = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "ZAPATOS", "BOTAS");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowAllProductsBoots = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "ZAPATOS", "BO");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProductsTeenisSneakers = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "TENIS", "SNEAKERS");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProductsTeenisPlatforms = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "TENIS", "PLATAFORMA");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProductsTeenisWithoutCords = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "TENIS", "SIN CORDONES");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProductsTeenisSports = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "TENIS", "DEPORTIVOS");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handerShowAllProductTeenis = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "TENIS", "S");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProductsSandsFlats = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "SANDALIAS", "PLANAS");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProdctsSandsPlatforms = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "SANDALIAS", "PLATAFORMA");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowProductsSandsMedium = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "SANDALIAS", "MEDIANAS");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
  ...
  const handlerShowAllPrductsSands = async () => {
    try {
      const data = await getAllProductPageByGenderByModelAndProductType(0, 9, "CABALLERO", "SANDALIAS", "S");
      dataTableProductAvailable(data);
    } catch (error) {
      console.log(error);
    }
